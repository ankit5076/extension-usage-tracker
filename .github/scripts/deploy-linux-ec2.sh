...
case "${PAYMENT_PROVIDER:-razorpay}" in
  dodo)
    required_env+=(
  ...
  razorpay)
    ...
    ;;
  *)
    echo "PAYMENT_PROVIDER must be dodo, paddle, or razorpay." >&2
    exit 1
    ;;
esac
...
RAZORPAY_CANADA_ACCESS_AMOUNT_SUBUNITS=${RAZORPAY_CANADA_ACCESS_AMOUNT_SUBUNITS:-}
RAZORPAY_UK_ACCESS_AMOUNT_SUBUNITS=${RAZORPAY_UK_ACCESS_AMOUNT_SUBUNITS:-}
RAZORPAY_CANADA_PRO_AMOUNT_SUBUNITS=${RAZORPAY_CANADA_PRO_AMOUNT_SUBUNITS:-}
RAZORPAY_UK_PRO_AMOUNT_SUBUNITS=${RAZORPAY_UK_PRO_AMOUNT_SUBUNITS:-}
...
DODO_PRODUCT_CANADA_ACCESS=${DODO_PRODUCT_CANADA_ACCESS:-}
DODO_PRODUCT_UK_ACCESS=${DODO_PRODUCT_UK_ACCESS:-}
DODO_PRODUCT_CANADA_PRO=${DODO_PRODUCT_CANADA_PRO:-}
DODO_PRODUCT_UK_PRO=${DODO_PRODUCT_UK_PRO:-}
ACCESS_DAYS_PER_PURCHASE=${ACCESS_DAYS_PER_PURCHASE:-30}
CANADA_ACCESS_DAYS_PER_PURCHASE=${CANADA_ACCESS_DAYS_PER_PURCHASE:-30}
UK_ACCESS_DAYS_PER_PURCHASE=${UK_ACCESS_DAYS_PER_PURCHASE:-30}
PRO_ACCESS_DAYS_PER_PURCHASE=${PRO_ACCESS_DAYS_PER_PURCHASE:-365}
CANADA_PRO_ACCESS_DAYS_PER_PURCHASE=${CANADA_PRO_ACCESS_DAYS_PER_PURCHASE:-365}
UK_PRO_ACCESS_DAYS_PER_PURCHASE=${UK_PRO_ACCESS_DAYS_PER_PURCHASE:-365}
PADDLE_ENVIRONMENT=${PADDLE_ENVIRONMENT:-sandbox}
PADDLE_API_KEY=${PADDLE_API_KEY:-}
PADDLE_WEBHOOK_SECRET=${PADDLE_WEBHOOK_SECRET:-}
PADDLE_PRICE_CANADA_ACCESS=${PADDLE_PRICE_CANADA_ACCESS:-}
PADDLE_PRICE_UK_ACCESS=${PADDLE_PRICE_UK_ACCESS:-}
